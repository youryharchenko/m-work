...
public class Work08 extends Work {
    ...
    public Work08() {
        ...
        plot.title = "Simulated Annealing search";
    ...
    public void run() {
        ...
        writeLog("\n Started...");
        writeLog("\n Function: y=(sin(4x)+2sin(e^x), x=[1.64;3.46]");

        SimulatedAnnealing simulatedAnnealing = new SimulatedAnnealing(1000.0, 1.0, 0.02);
        simulatedAnnealing.search(this, 1.64, 3.46, 0.001);
