...
# ╔═╡ e6ff77fe-ad18-11ed-27d9-034c1d54164a
using MLDatasets, IterTools, CUDA

# ╔═╡ 85fb637f-da9b-4765-865b-fbf7c133afde
using Knet: relu, minibatch, param, param0, adam, progress!, conv4

# ╔═╡ 6b1388fe-f843-4fdc-a9f3-5cbd3ce24402
md"""
# Quick start
...
# ╔═╡ eaa499c1-f271-4aa7-8c7d-61e806831d1f
ENV["COLUMNS"]=72

# ╔═╡ d26df332-54cd-4865-a3e9-f6acf546c86c
begin
...
# ╔═╡ ae238c55-97ee-48be-8488-de12ed4e3c6c
begin
# Define dense layer:
struct Dense 
	w 
...
# ╔═╡ 4962892d-3d62-4b2b-a51a-ba6e7df7ea2f
begin
...
# ╔═╡ 9c414d0b-1f66-416f-9e18-bbd188c5cab9
begin
	# Load MNIST data
...
# ╔═╡ 142c3596-ed8c-4aac-8e8c-7b3a92ca03ab
# Train and test LeNet (about 30 secs on a gpu to reach 99% accuracy)

# ╔═╡ 88b57d97-c53e-4daa-8427-8e9eb9bb5a47
begin
...
# ╔═╡ 69d65cba-ec8e-4df3-894c-d84bfa584b33
ad = adam(LeNet, ncycle(dtrn, 10))

# ╔═╡ 5f341cab-9afb-49a5-b82b-7c0e5762fe79
CUDA.similar

# ╔═╡ cfef415c-95ce-4c10-9c0a-01588bf8e766
progress!(ad)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "362ea56a4461eb96e0fe6a569a2f7d31f6ec42d2"
