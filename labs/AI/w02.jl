...
# ╔═╡ b6d387da-ca3b-11ed-1648-b527f78fff19
using Word2Vec

# ╔═╡ 15467cbf-78cd-4fbb-8bdd-4c237a71fc6c
using Gadfly

# ╔═╡ 948a18fa-b370-40e1-a8ca-dbb17144813b
model = wordvectors("text8-vec.txt")

# ╔═╡ 5a9b3a27-f885-4bc9-a1c7-4a797550a559
size(model)

# ╔═╡ ab35e6ea-381a-4b4c-9ec9-0eb1f422b7ae
words = vocabulary(model)

# ╔═╡ eacbeec0-bb4f-4dff-96a3-7395d4494797
idx = index(model, "book")

# ╔═╡ bee97e12-b902-494c-a634-216029516cd2
words[idx]

# ╔═╡ efc15574-2577-43be-a7cf-43b70a99da3b
get_vector(model, "one")

# ╔═╡ 3e861577-1438-4034-ba94-8481fe6e44ff
similarity(model, "one", "two")

# ╔═╡ c373b229-c9e9-4bd0-a53b-f472161c4fdd
similarity(model, "one", "hello")

# ╔═╡ f1634304-c40e-40c9-a51a-b2f3c559c2b1
idxs, dists = cosine(model, "paris", 10)

# ╔═╡ 66f9e41f-2e29-40c8-8451-aa2a3addff2d
plot(x=words[idxs], y=dists)

# ╔═╡ b4f21033-ec53-4d28-9f5f-be99b1d9ccd2
idxs2, dists2 = analogy(model, ["king", "woman"], ["man"], 8)

# ╔═╡ 1d6fcb3c-1c2c-4b8c-9ace-2c222c66c696
plot(x=words[idxs2], y=dists2)

# ╔═╡ f4e27ac7-1178-4070-aeeb-b17166048e7c
analogy_words(model, ["paris", "germany"], ["france"], 10)

# ╔═╡ 6b9a5df0-99a3-457a-96ae-1e81cffc0d61
model2 = wordvectors("text8phrase-vec.txt")

# ╔═╡ 04bd9f58-9a14-463d-aa73-69ce837f69c7
cosine_similar_words(model2, "los_angeles", 13)

# ╔═╡ fa3617ed-4a29-41be-8a90-30dd41af978a
model3 = wordclusters("text8-class.txt")

# ╔═╡ a79202c7-f5ac-4499-a13c-494b4edb4fe1
clusters(model3)

# ╔═╡ 93294755-6d46-4941-b5b9-318b2c879f87
get_cluster(model3, "two")

# ╔═╡ 2760ea8f-5f28-44ae-b852-8d60b678669f
get_words(model3, 39)

# ╔═╡ 7ba2cd83-b7d0-4de7-85f6-a367cf76273c
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "973aa59cb16acc4d6ce0e77c9e353dd0d5a4cc55"
