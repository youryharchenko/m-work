...
# ╔═╡ a6876fb4-a62f-11ed-3367-1d284cfba775
using Flux, Plots

# ╔═╡ 441d6eae-e1ae-4859-a6f7-cd18fd116a0b
md"""
...
# ╔═╡ 3867730f-2db5-4dba-bf04-71500f3cee40
p = plot(celu,  -2, 2, height=7, xticks=([0], [0]), yticks=([0], [0]), label="celu")

# ╔═╡ 460bf674-f476-4ac5-8d3b-cb88311a1a47
md"""
Exponential Linear Unit activation function.  ["Fast and Accurate Deep Network Learning by Exponential Linear Units"](https://arxiv.org/abs/1511.07289).

elu(x, α=1) = x > 0 ? x : α * (exp(x) - 1)
"""

# ╔═╡ 3ef98708-2c65-4457-b63f-c6051d00feba
plot(elu, -2, 2, height=7, xticks=([0], [0]), yticks=([0], [0]), label="elu")

# ╔═╡ effa9358-eb39-4a02-9bce-eb05e8908094
md"""
...
# ╔═╡ b212c681-3ebc-40d9-846d-983941007be5
plot(gelu, -2, 2, height=7, xticks=([0], [0]), yticks=([0], [0]), label="gelu")

# ╔═╡ 39ddc46d-288e-4f68-a08f-c7fa73e56855
md"""
...
# ╔═╡ 08c80809-c99c-47db-94b6-e1de7033e028
begin
...
# ╔═╡ ed16e56c-a894-4f01-883c-fbf2c3da2b99
begin
...
# ╔═╡ d3df5c6b-7527-424f-86da-d020d69c082f
plot(x -> leakyrelu(x, 0.5), -2, 2, height=7, xticks=([0], [0]), yticks=([0], [0]), label="leakyrelu")

# ╔═╡ 1772e4e4-3360-4a4d-9122-a6cd0f12a787
md"""
...
# ╔═╡ 4ea97651-ea51-4b44-a460-a2ee8a5e1ad2
begin
	plot(lisht, -2, 2, height=7, xticks=([0], [0]), yticks=([0], [0]), label="lisht")
	plot!(logcosh, -2, 2, height=7, xticks=([0], [0]), yticks=([0], [0]), label="logcosh")
	
end

# ╔═╡ 2e4860ad-9dac-407c-b444-3013e2ae5339
md"""
...
# ╔═╡ 0b42ba34-41d6-46cd-8686-310308e748c1
plot(logsigmoid, -5, 5, height=7, xticks=([0], [0]), yticks=([0], [0]), label="logsigmoid")

# ╔═╡ 725aa532-eb8c-40e8-91fb-c3a2d1fdff2c
md"""
...
# ╔═╡ 03f20f4b-7c96-412b-9319-59532d04649b
begin
	plot(relu, -10, 10, height=7, xticks=([0], [0]), yticks=([0], [0]), label="relu")
	plot!(relu6, -10, 10, height=7, xticks=([0], [0]), yticks=([0], [0]), label="relu6")
	
end

# ╔═╡ d5760034-75ff-4b87-86ff-0e24bdbe5387
md"""
...
# ╔═╡ 8c46d215-1d3c-400d-9cb5-05adf96f44cc
plot(rrelu, -10, 10, height=7, xticks=([0], [0]), yticks=([0], [0]), label="rrelu")

# ╔═╡ 323145c6-298a-44d0-bd1e-5b64d0d5fd40
md"""
...
# ╔═╡ ed5ab949-1211-4bc9-8f0d-b316d2307047
plot(selu, -3, 2, height=7, xticks=([0], [0]), yticks=([0], [0]), label="selu")

# ╔═╡ 44cea679-4329-4f43-ab7e-73e930caa313
md"""
...
# ╔═╡ 921cd17b-b5ae-4357-8f04-b9d477a11e9e
plot(softplus, -3, 3, height=7, xticks=([0], [0]), yticks=([0], [0]), label="softplus")

# ╔═╡ 95e2b183-912a-4c73-a626-949b60800d21
md"""
...
# ╔═╡ c45b22b7-aa20-4080-b6cf-be45f1af4128
plot(softshrink, -3, 3, height=7, xticks=([0], [0]), yticks=([0], [0]), label="softshrink")

# ╔═╡ abd2f057-f860-4cb7-a668-91f31247056a
md"""
...
# ╔═╡ a55b9700-9623-4bc5-8b27-95d00ee6a9e0
plot(softsign, -5, 5, height=7, xticks=([0], [0]), yticks=([0], [0]), label="softsign")

# ╔═╡ 9a6ee41a-66a7-4d16-93dc-3d40e385ef7e
md"""
...
# ╔═╡ b36b3421-da81-4462-a48c-39ac417019be
begin
	plot(swish, -4, 5, height=7, xticks=([0], [0]), yticks=([0], [0]), label="swish")
	plot!(hardswish, -4, 5, height=7, xticks=([0], [0]), yticks=([0], [0]), label="hardswish")
	
end

# ╔═╡ ce5428b9-6bbe-4d83-bf23-bff08cff6af4
md"""
...
# ╔═╡ 1fbbcbae-04cb-4d23-aa40-696afa33e574
plot(tanhshrink, -3, 3, height=7, xticks=([0], [0]), yticks=([0], [0]), label="tanhshrink")

# ╔═╡ 55b80d0f-dea4-4be5-b798-a35e1dbc5110
md"""
...
# ╔═╡ 8f0092e5-14a4-49ec-acb1-051f70579b03
plot(trelu, -3, 3, height=7, xticks=([0], [0]), yticks=([0], [0]), label="trelu")
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "919aa57aa35f51041fae1f2ce5daf7dea583ede2"
