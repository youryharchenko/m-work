...
# ╔═╡ 7a13b734-6591-11ed-3c0f-a1d1fce1efe3
using GZip, CSV, DataFrames, Dates, CommonMark

# ╔═╡ f177ae5f-6801-442b-a3a3-ae8ffe160be4
header=["ip","f1","f2","ts","met","ret","nb","f4","br"]

# ╔═╡ a814f2a9-f90a-49b5-b46d-c12ff0b006f3
log = let
...
# ╔═╡ 2326ae83-83a1-414e-8ce3-967762a5d4af
work_set = ["ip","met","ret","br"]

# ╔═╡ 2fc4cef2-6849-4a22-aaab-c501f415353b
wdf = combine(groupby(log, work_set),nrow=>:count)

# ╔═╡ 42ed6af4-6124-400e-a20b-8fb92519c775
CSV.write("logs.csv", wdf)
