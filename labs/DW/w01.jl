...
# ╔═╡ 97a4c65b-7c43-46fe-a068-67b31836f65c
md"""
...
# ╔═╡ 7c761de4-ff04-4b8d-b281-e6a205ed8e7f
md"""
# Обов'язкова програма для атестації
"""

# ╔═╡ 4d89aade-d589-4e14-b82d-474ef72ccfea
md"""
## Мета проекту
"""

# ╔═╡ e947279e-1547-439c-aaf5-8665fc89e5f6
md"""
Існують три види мотивації до дій:

* цікавість;
* користь;
* примус.

В цьому проекті нема нічого цікавого, користі від нього теж ніякої, значить робимо висновок: причина виконаного в цьому розділі - примус, тож і мета відповідна. 
"""

# ╔═╡ 7b6ad707-2234-47a1-80e5-3c93dbab4f50
md"""
## Прецеденти
"""

# ╔═╡ 8f03e4b0-61d9-432d-bd80-29f88e7f8ca8
let
usecase = """
@startuml
...
# ╔═╡ 503dd3e6-539a-4bda-9648-9f7525c08bcc
md"""
## Топологія
"""

# ╔═╡ 2db795a4-583e-440f-a31e-6b982df41240
let
topology = """
@startuml
...
# ╔═╡ 30ce9c76-8788-4bdb-b470-364efc2395f4
md"""
## Структура бази даних OLTP 
"""

# ╔═╡ 501a7788-97e0-4a71-bb6b-1f77892ea88c
LocalResource("structure_db.png")

# ╔═╡ 8d9e1c3d-6181-4e3a-9919-f73266fb5ac8
md"""
## Аналітичні запити
"""

# ╔═╡ 9c0f8f5c-6a77-4f19-8fab-0d53d774c66c
md"""
