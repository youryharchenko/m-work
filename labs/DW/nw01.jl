...
# ╔═╡ 2132a9d4-71aa-11ed-2010-29a198dc2618
using LibPQ, Tables, DataFrames

# ╔═╡ bdfd3164-bd54-404f-b89b-eb60f8d9fc91
password = "work";

# ╔═╡ 9ae0a8b1-001f-40f7-b45f-73b395528731
conn = LibPQ.Connection("host=localhost dbname=work user=work password=$password")

# ╔═╡ a36930bc-7aeb-4a8d-a19c-041af33c3860
df_term = let
...
execute(conn, 
"""
INSERT INTO Terminals(id, name, id_partner)
VALUES
(1, 'Term01', 1),
(2, 'Term02', 3),
(3, 'Term03', 4);
...
# ╔═╡ 6c1a92bd-e9c3-4e2d-8724-f3b1dcdd962b
df_type_trx = let
	
execute(conn, 
"""
DROP TABLE IF EXISTS TypeTrx;
CREATE TABLE IF NOT EXISTS TypeTrx 
(
	id INTEGER PRIMARY KEY,
	name VARCHAR(32) NOT NULL UNIQUE
);
...
# ╔═╡ 10dd825e-def1-4f04-8e59-188921f00954
df_part = let
...
# ╔═╡ b93e8a1e-5484-4208-ab71-bf261c1e72af
df_trx = let
...
(
	...
	FOREIGN KEY(id_term) REFERENCES Terminals(id),
	FOREIGN KEY(id_type) REFERENCES TypeTrx(id)
);
"""
)
...
VALUES
(1, '2022-12-03T09:31:00', 15897, 1, 1),
(2, '2022-12-03T10:07:12', 34789, 1, 2),
(3, '2022-12-03T11:24:43', 83479, 2, 2),
(4, '2022-12-03T08:15:26', 46540, 3, 1);
"""
)
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "03cc03632bd7f9f2b41c8dce048eaa90876c4f4a"
