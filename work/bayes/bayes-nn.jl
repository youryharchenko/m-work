...
# ╔═╡ 460f7dba-3903-11ee-1e52-837c5d207efd
begin 
using Turing
using FillArrays
using Flux
...
# ╔═╡ afa94e08-bdec-499b-bcf8-768635b308e5
# Use reverse_diff due to the number of parameters in neural networks.
Turing.setadbackend(:reversediff)

# ╔═╡ 99b7af83-7ec0-476d-80e3-22eeb13be008
# Number of points to generate.
N = 80

# ╔═╡ 1924546c-b99c-4179-b590-394445ba0549
M = round(Int, N / 4)

# ╔═╡ 1fa65040-4427-4f53-846e-ce7247403583
Random.seed!(1234)

# ╔═╡ f03fc1a1-bdc1-4f56-b9ea-ca0b13af13b8
# Generate artificial data.
xt1s, xt0s = let
	# Generate artificial data.
x1s = rand(M) * 4.5;
x2s = rand(M) * 4.5;
xt1s = Array([Float32.([x1s[i] + 0.5; x2s[i] + 0.5]) for i in 1:M])
x1s = rand(M) * 4.5;
x2s = rand(M) * 4.5;
append!(xt1s, Array([Float32.([x1s[i] - 5; x2s[i] - 5]) for i in 1:M]))

x1s = rand(M) * 4.5;
x2s = rand(M) * 4.5;
xt0s = Array([Float32.([x1s[i] + 0.5; x2s[i] - 5]) for i in 1:M])
x1s = rand(M) * 4.5;
x2s = rand(M) * 4.5;
append!(xt0s, Array([Float32.([x1s[i] - 5; x2s[i] + 0.5]) for i in 1:M]))

xt1s, xt0s
end

# ╔═╡ 5485c995-3aad-40e5-ab0c-401e7d74f0e6
xs = [xt1s; xt0s]

# ╔═╡ 3ddcb76f-f5f1-4381-919b-4fae01268f2d
ts = [ones(Float32, 2 * M); zeros(Float32, 2 * M)]

# ╔═╡ 3d79127a-cded-4617-ba56-38ba55bf7ff9
function plot_data()
    x1 = map(e -> e[1], xt1s)
    y1 = map(e -> e[2], xt1s)
    x2 = map(e -> e[1], xt0s)
...
# ╔═╡ 5e1c96ec-5a8f-4409-acb4-c1a771539d54
plot_data()

# ╔═╡ dca2e2f0-5347-4656-b7ff-3b4416fad749
# Construct a neural network using Flux
nn_initial = Chain(Dense(2, 3, tanh), Dense(3, 2, tanh), Dense(2, 1, σ))

# ╔═╡ 331eaa25-7565-4cae-a0a2-65b28fc9086a
# Extract weights and a helper function to reconstruct NN from weights
parameters_initial, reconstruct = Flux.destructure(nn_initial)


# ╔═╡ d585bea7-a03f-4fda-9e06-a6d16d9add0f
length(parameters_initial) # number of paraemters in NN

# ╔═╡ a3dca60e-c96b-429a-949d-88f9dd32c339
...
# ╔═╡ ae35bf50-0ac8-4b4d-bda5-48ccf7442811
ch = sample(bayes_nn(hcat(xs...), ts, length(parameters_initial), reconstruct), NUTS(), 5000)

# ╔═╡ 077be466-df7d-4947-b138-f725ed795e69
# Extract all weight and bias parameters.
theta = MCMCChains.group(ch, :parameters).value

# ╔═╡ f89d5a59-9f85-4c12-af3b-4c136ab6586f
# A helper to create NN from weights `theta` and run it through data `x`
nn_forward(x, theta) = reconstruct(theta)(x)

# ╔═╡ 016d0f90-8592-42d8-88ff-47d5290b5d14
plot_data()

# ╔═╡ 65521271-412c-4263-8623-f8ed3f759a8a
# Find the index that provided the highest log posterior in the chain.
_, i = findmax(ch[:lp])

# ╔═╡ 3d2e1610-e5d4-47a1-b3e2-c5901c027241
# Extract the max row value from i.
ii = i.I[1]

# ╔═╡ da86345b-147c-40b8-a4f4-d8753b92f7f6
# Plot the posterior distribution with a contour plot

# ╔═╡ b8aaa864-6310-43bd-ae20-343ac7e0f171
x1_range = collect(range(-6; stop=6, length=25))

# ╔═╡ 08a6b166-6f57-4afd-adef-2a218bfd4d7b
x2_range = collect(range(-6; stop=6, length=25))

# ╔═╡ 38f50f59-21f2-4da0-81eb-dd1ad2ef335c
Z = [nn_forward([x1, x2], theta[ii, :])[1] for x1 in x1_range, x2 in x2_range]

# ╔═╡ 859958dc-ffbc-4189-81ec-d395b79bd27e
contour!(x1_range, x2_range, Z)

# ╔═╡ d75fc7f3-e29d-4d9b-95a1-536f98a65188
...
# ╔═╡ a727f91f-adf3-4ef1-b8ce-db74211bc3ed
let
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "d0e2fd591bf5f592ebb3587f4cf5e175254097e0"
